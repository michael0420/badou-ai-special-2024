...
'''
1. Grayscale Test
Three kinds of grayscale ways: (1) invoke cv2 package, (2) invoke pyplot package, (3) self codes
...
cv2_gray_img = lenna_img.get_gray_image('cv2')  # use cv2 package
plt_gray_img = lenna_img.get_gray_image('pyplot')  # use matplotlib.pyplot
my_gray_img = lenna_img.get_gray_image()  # convert to gray by self code
